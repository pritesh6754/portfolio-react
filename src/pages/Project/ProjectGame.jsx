                    ...
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://Alihasan06.github.io/Memorama" target="_blank">https://Alihasan06.github.io/Memorama</a>
                            </div>
                ...
                <div className="content-modal">
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://https://Alihasan06.github.io/Ajedrez2.0/" target="_blank">https://https://Alihasan06.github.io/Ajedrez</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
                ...
                <div className="content-modal">
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://Alihasan06.github.io/Juego-de-la-Serpiente/" target="_blank">https://Alihasan06.github.io/Juego-de-la-Serpiente/</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
                ...
                <div className="content-modal">
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <a href="https://Alihasan06.github.io/Preguntas-y-Respuestas/" target="_blank">https://Alihasan06.github.io/Preguntas-y-Respuestas/</a>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
