        ...
        <section className="inicio" id="inicio">
            ...
            <div className="titulo">
                ...
                <div className="redes-sociales">
                    ...
                    <a href="https://github.com/Alihasan06/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1400"><i className="fab fa-github"></i></a>
                ...
                <div className="wrapper">
                    ...
                    <a className="button" href="https://github.com/Alihasan06/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1400">
                        <div className="icon">
