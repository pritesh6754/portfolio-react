    ...
    return (
        <header className="site-header">
            ...
            <nav className="navbar">
                ...
                <div id="buttons">
                    <img onClick={() => idioma.selectLanguage('en-US')} src="https://Alihasan06.github.io/Portafoliovirtual/img/en.png" alt="EEUU" />
                    <img onClick={() => idioma.selectLanguage('es-ES')} src="https://Alihasan06.github.io/Portafoliovirtual/img/es.png" alt="España" />
                </div>
            </nav>
